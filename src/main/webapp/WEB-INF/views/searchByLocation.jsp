				...
				<div class="col-md-4">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<img src="resources/pic/hotel1.jpeg" height="150" width="370"
								class="img-rectangle" />
						</div>
						<div class="panel-footer">
							<c:out value="${hotelBasedOnLocation.hotelDescription}" />
							<br /> <a><c:out value="${hotelBasedOnLocation.hotelWebsite}" /></a>
							<p>
								<a class="btn"
									href="hotelTemplate/<c:out value="${hotelBasedOnLocation.id}" />">View
									details »</a>
							</p>
						</div>
					</div>
