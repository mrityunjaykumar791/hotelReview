...
<body>
	...
	<div class="row">
		...
		<div class="col-md-4">
			<form:form action="signUpAction" method="post"
				...
				<div class="form-group has-feedback">
					<input type="password" class="form-control"
						placeholder="Confirm Password" name="cnfPassword" id="cnfPassword"
						onblur="passValidate()" required="required" /> <i
						class="glyphicon glyphicon-lock form-control-feedback"></i>
				</div>

				<div class="row">
					<span class="col-md-6"> <input type="submit"
						class="btn btn-primary custom-but  btn-signin" value="Submit" />
			...
			<form action="signIn">
				<div>
					<label>Already Registered:<a href="signIn"
						class="graycolor">Click Here</a></label>
				</div>
			</form>
		</div>
	</div>
